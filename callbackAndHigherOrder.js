...
// CODE HERE
function multiply(numOne, numTwo, callback){
...
// CODE HERE 
function getUserById(array, ident, callback){
  array.filter(object => {
    if(object.id === ident){
      callback(object)
    }
...
// CODE HERE
addFortyTwo = addingFactory(42)
console.log(addFortyTwo(12))
console.log(addFortyTwo(27))